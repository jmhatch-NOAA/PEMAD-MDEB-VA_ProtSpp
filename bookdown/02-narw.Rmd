...
# data
narw_abundance = '../data-raw/MDAT_MammalModels_Abundance/MammalModels_Abundance/commondata/raster_data' |>
...
map = leaflet(width = '100%') |>
  ...
  addPolygons(data = mari, fillColor = 'transparent', color = 'white', popup = ~LEASENM, weight = 2, opacity = 1) |>
